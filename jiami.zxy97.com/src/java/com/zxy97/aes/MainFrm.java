...
public class MainFrm extends javax.swing.JFrame {
                            ...
                            .isDataFlavorSupported(DataFlavor.javaFileListFlavor)) {
                                ...
                                for (File file : list) {
                                    ...
                                    if (file.isDirectory()) {
                                        ...
                                        jLabel15.setText(Util.getFileSize(file.length()));
                                        jLabel16.setText(Util.getFileSize(file.length()));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (file4 != null) {
            ...
            jLabel16.setText(Util.getFileSize(file4.length()));
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (file1 != null) {
            ...
            if (file1.isDirectory()) {
                ...
                jLabel15.setText(Util.getFileSize(file1.length()));
            }
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            ...
            Util.openExplorer(file.getParent());
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        try {
            ...
            Util.openExplorer(file.getAbsolutePath());
        } catch (IOException ex) {
            jLabel15.setText("文件夹路径有误，打开失败！");
        }
